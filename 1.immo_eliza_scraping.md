...
- It should feature code contributions from each member
...
- Use concurrency [../../2.python/2.python_advanced/Extras/06.Concurrency/] to increase the speed of data collection
...
2. Pimp up the README file:
   ...
   - (Timeline)
   - (Personal situation)
3. Small presentation (to coaches):
   - How you did it ? Each member of the team should explain a part of their solution.
   - Who did what ?
   - What went wrong ?
   - How you solved it ?
